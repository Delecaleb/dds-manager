...
class SyncOpenDentalHistAppointments extends Command
{
     ...
     * @var string
     */
    protected $description = 'Sync historical appointments from OpenDental to local database (supports optional --start-date, --end-date, and --office-id)';
    ...
    public function handle(): int
    {
        ...
        return $this->syncEachOffice('historical appointments', function ($office) use ($start, $end) {
            $syncService = app(HistAppointmentSyncService::class)->forOffice($office);
