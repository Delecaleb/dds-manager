...
Route::middleware('auth')->group(function () {
    ...
    // Offices / Locations Management Module
    ...
    // Aging Module
    Route::middleware('module:aging')->group(function () {
    ...
    Route::middleware('module:provider-portal')->group(function () {
    ...
    // Financials Module
    Route::middleware('module:financials')->group(function () {
    ...
    // Deposit Slip Module
    Route::middleware('module:deposits')->group(function () {
    ...
    // EOD Module
    Route::middleware('module:eod')->group(function () {
        Route::get('eod', function () {
            return view('eod.index');
        })->name('eod.index');
    });

    // Morning Huddle Module
    Route::middleware('module:huddle')->group(function () {
    ...
    // Snapshot Module
    Route::middleware('module:snapshot')->group(function () {
    ...
    // Front Office Module
    Route::middleware('module:front-office')->group(function () {
    ...
    // RCM Module
    Route::middleware('module:rcm')->group(function () {
        Route::get('rcm', [RcmController::class, 'index'])->name('rcm.index');
        Route::get('rcm/data', [RcmController::class, 'data'])->name('rcm.data');
        Route::get('rcm/export', [RcmController::class, 'export'])->name('rcm.export');
    });

    // Provisioner Module
    Route::middleware('module:provisioner')->group(function () {
    ...
    // Tx Miner Module
    Route::middleware('module:tx-miner')->group(function () {
        ...
        Route::get('tx-miner/data-provider', [TxMinerController::class, 'dataProvider'])->name('tx-miner.data-provider');
        Route::get('tx-miner/data-location', [TxMinerController::class, 'dataLocation'])->name('tx-miner.data-location');
        Route::get('tx-miner/drilldown', [TxMinerController::class, 'drilldown'])->name('tx-miner.drilldown');
        Route::get('tx-miner/export', [TxMinerController::class, 'exportCsv'])->name('tx-miner.export');
    });

    // Hygiene Recall Module
    ...
    Route::middleware('module:od-explorer')->group(function () {
    ...
    Route::middleware('module:sync-manager')->group(function () {
