    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-2xl w-full max-w-4xl mx-4 flex flex-col">
        ...
        <div class="flex items-center justify-between px-6 py-4">
            <div class="flex items-center gap-3">
                <div id="patientAvatar"
                    class="w-11 h-11 rounded-full bg-violet-500 flex items-center justify-center text-white text-sm font-bold shrink-0">??</div>
        ...
        <div class="px-6 border-b border-slate-100">
            <nav class="flex gap-5" id="patientTabNav">
                <button data-tab="pm-info"     class="pm-tab pb-3 text-sm font-semibold border-b-2 border-emerald-500 text-slate-900">Info</button>
                <button data-tab="pm-family"   class="pm-tab pb-3 text-sm font-medium border-b-2 border-transparent text-slate-400 hover:text-slate-600">Family</button>
                <button data-tab="pm-employer" class="pm-tab pb-3 text-sm font-medium border-b-2 border-transparent text-slate-400 hover:text-slate-600">Employer</button>
                <button data-tab="pm-ledger"   class="pm-tab pb-3 text-sm font-medium border-b-2 border-transparent text-slate-400 hover:text-slate-600">Ledger</button>
                <button data-tab="pm-txplans"  class="pm-tab pb-3 text-sm font-medium border-b-2 border-transparent text-slate-400 hover:text-slate-600">TX Plans</button>
                <button data-tab="pm-ar"       class="pm-tab pb-3 text-sm font-medium border-b-2 border-transparent text-slate-400 hover:text-slate-600">AR Summary</button>
                <button data-tab="pm-notes"    class="pm-tab pb-3 text-sm font-medium border-b-2 border-transparent text-slate-400 hover:text-slate-600">Activities and Notes</button>
                <button data-tab="pm-reminder" class="pm-tab pb-3 text-sm font-medium border-b-2 border-transparent text-slate-400 hover:text-slate-600">Reminder</button>
            </nav>
        </div>
        ...
        <div class="px-6 py-5 flex-1 min-h-[380px]">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div class="border border-slate-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-2 gap-x-6 gap-y-4 text-xs mb-4">
                            <div><p class="text-slate-400 mb-0.5">Age</p><p class="font-bold text-slate-800" id="pi-age">—</p></div>
                            <div><p class="text-slate-400 mb-0.5">Gender</p><p class="font-bold text-slate-800" id="pi-gender">—</p></div>
                            <div><p class="text-slate-400 mb-0.5">Birthdate</p><p class="font-bold text-slate-800" id="pi-birthdate">—</p></div>
                            <div><p class="text-slate-400 mb-0.5">Status</p><p class="font-bold text-slate-800" id="pi-status">—</p></div>
                        </div>
                        <div class="border-t border-slate-100 pt-4 grid grid-cols-2 gap-x-6 gap-y-4 text-xs mb-4">
                            <div><p class="text-slate-400 mb-0.5">Mobile Phone</p><p class="font-bold text-slate-800" id="pi-mobile">—</p></div>
                            <div><p class="text-slate-400 mb-0.5">Work Phone</p><p class="font-bold text-slate-800" id="pi-work">—</p></div>
                            <div><p class="text-slate-400 mb-0.5">Home Phone</p><p class="font-bold text-slate-800" id="pi-home">—</p></div>
                            <div><p class="text-slate-400 mb-0.5">Email Address</p><p class="font-bold text-slate-800 truncate" id="pi-email">—</p></div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-3 text-xs">
                            <div><p class="text-slate-400 mb-0.5">Address</p><p class="font-bold text-slate-800" id="pi-address">—</p></div>
                            <div><p class="text-slate-400 mb-0.5">City</p><p class="font-bold text-slate-800" id="pi-city">—</p></div>
                            <div><p class="text-slate-400 mb-0.5">Zip</p><p class="font-bold text-slate-800" id="pi-zip">—</p></div>
                        </div>
                    </div>
                    <div class="border border-slate-200 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-2 gap-3 text-xs">
                            <div class="border border-slate-100 rounded p-3">
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 17L17 7"/><path d="M7 7h10v10"/></svg>
                                </div>
                            ...
                            <div class="border border-slate-100 rounded p-3">
                                ...
                                <div class="flex gap-4">
                                    <div><p class="font-bold text-slate-800" id="ov-tp-sched">$ 0</p><p class="text-slate-400 text-[10px]">Scheduled</p></div>
                                    <div><p class="font-bold text-slate-800" id="ov-tp-unsched">$ 0</p><p class="text-slate-400 text-[10px]">Unsched</p></div>
                                </div>
                            </div>
                            <div class="border border-slate-100 rounded p-3">
                            ...
                            <div class="col-span-2 border border-slate-100 rounded p-3">
                                ...
                                <div class="grid grid-cols-3 text-center gap-2">
                                    <div>
                                        <p class="font-bold text-slate-800 text-base" id="ov-apt-completed-pct">0.00%</p>
                                        <p class="text-slate-400 text-[10px]">Completed: <span id="ov-apt-completed-cnt">0</span></p>
                                    </div>
                                    <div>
                                        <p class="font-bold text-slate-800 text-base" id="ov-apt-sched-pct">0.00%</p>
                                        <p class="text-slate-400 text-[10px]">Scheduled: <span id="ov-apt-sched-cnt">0</span></p>
                                    </div>
                                    <div>
                                        <p class="font-bold text-slate-800 text-base" id="ov-apt-broken-pct">0.00%</p>
                                        <p class="text-slate-400 text-[10px]">Broken: <span id="ov-apt-broken-cnt">0</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="border border-slate-200 rounded-lg overflow-hidden">
                    <table class="w-full text-xs text-slate-700">
                        ...
                        <tbody id="pm-family-body">
                            <tr><td colspan="6" class="p-4 text-center text-slate-400">No Data</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div id="pm-employer" class="pm-panel hidden">
                <div class="border border-slate-200 rounded-lg p-4 bg-white">
                    ...
                    <p class="text-sm font-bold text-slate-800" id="pm-employer-name">No employer information available.</p>
                </div>
            </div>
                ...
                <div class="border border-slate-200 rounded-lg overflow-hidden">
                    <table class="w-full text-xs text-slate-700">
                        ...
                        <tbody id="pm-ledger-body">
                            <tr><td colspan="7" class="p-4 text-center text-slate-400">No Data</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
                ...
                <div class="border border-slate-200 rounded-lg overflow-hidden overflow-x-auto">
                    <table class="w-full text-xs text-slate-700 min-w-[780px]">
                        ...
                        <tbody id="pm-txplans-body">
                            <tr><td colspan="11" class="p-4 text-center text-slate-400">No Data</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div id="pm-ar" class="pm-panel hidden">
                ...
                <div class="border border-slate-200 rounded-lg p-4 mb-4">
                    <div class="grid grid-cols-7 gap-3 text-xs" id="ar-card-grid">
                        <div><p class="text-slate-400 mb-0.5">Total</p><p class="font-bold text-slate-800" id="ar-total">$ 0</p></div>
                        <div><p class="text-slate-400 mb-0.5">Insurance Claims</p><p class="font-bold text-slate-800" id="ar-insurance">$ 0</p></div>
                        <div><p class="text-slate-400 mb-0.5">Estimated Patients</p><p class="font-bold text-slate-800" id="ar-estimated">$ 0</p></div>
                        <div><p class="text-slate-400 mb-0.5">Current</p><p class="font-bold text-slate-800" id="ar-current">$ 0</p></div>
                        <div><p class="text-slate-400 mb-0.5">30+ Days</p><p class="font-bold text-slate-800" id="ar-30">$ 0</p></div>
                        <div><p class="text-slate-400 mb-0.5">60+ Days</p><p class="font-bold text-slate-800" id="ar-60">$ 0</p></div>
                        <div><p class="text-slate-400 mb-0.5">90+ Days</p><p class="font-bold text-slate-800" id="ar-90">$ 0</p></div>
                    </div>
                </div>
                <div class="border border-slate-200 rounded-lg overflow-hidden">
                    <table class="w-full text-xs text-slate-700">
                        ...
                        <tbody id="pm-ar-body">
                            <tr><td colspan="5" class="p-4 text-center text-slate-400">No Data</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
            ...
            <div id="pm-notes" class="pm-panel hidden">
                <div class="border border-slate-200 rounded-lg p-4 bg-white">
                    ...
                    <p class="text-sm text-slate-700 whitespace-pre-line" id="pm-patient-notes">No activities or notes available.</p>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="relative inline-flex items-center border border-slate-300 rounded px-3 py-2 text-xs text-slate-700 bg-white gap-2 cursor-pointer">
                                    ...
                                    <input type="date" id="reminder-date" class="border-0 outline-none text-xs bg-transparent text-slate-700 cursor-pointer" value="{{ date('Y-m-d') }}">
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    <label class="block text-xs text-slate-500 mb-1.5">Type</label>
                                    <select id="reminder-type" class="w-full border border-slate-300 rounded px-3 py-2 text-xs text-slate-700 bg-white focus:outline-none focus:border-emerald-500 appearance-none">
                                        <option value="">Select option</option>
                                        <option>Call</option><option>Email</option>
                                        <option>Text</option><option>Follow Up</option>
                                    </select>
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <select id="reminder-assignee" class="w-full border border-slate-300 rounded px-3 py-2 text-xs text-slate-700 bg-white focus:outline-none focus:border-emerald-500 appearance-none">
                            ...
                            <div class="flex justify-end">
                                <button id="submitReminderBtn" class="bg-emerald-400 hover:bg-emerald-500 text-white text-xs font-semibold px-6 py-2 rounded transition-colors">Add Reminder</button>
                            </div>
                        </div>
                    </div>
                    <div>
