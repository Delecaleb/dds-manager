@php
    $metricDescriptions = [
        ...
        'BYO Co Pay Coll' => 'The total amount collected from a patient divided by what was expected to be collected from a patient (based on insurance estimates & write-offs), multiplied by 100.',
    ...
    <div class="bg-white border rounded shadow-sm {{ empty($subtabs) ? '' : 'rounded-tl-none -mt-px relative z-0' }}">
        ...
        <div class="flex items-center px-6 py-2 gap-4 text-xs font-bold text-slate-800">
            <div class="flex items-center gap-2">
                ...
                {{ count($locationNames ?? []) === 1 ? $locationNames[0] : 'Selected Locations' }}
            </div>
